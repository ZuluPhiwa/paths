...
import {FaInstagram,FaFacebookSquare,FaGithubSquare,FaTwitterSquare,FaDribbbleSquare,FaWhatsapp,FaFacebook,FaYoutube} from 'react-icons/fa'
const Footer = () => {
  return (
...
<ul className=' justify-center mx-auto flex'>
  <a href="#" target="_blank" rel="noopener noreferrer"><li className='mx-4'><FaWhatsapp size={30}/></li></a>  
   ...
   <a href="#" target="_blank" rel="noopener noreferrer"><li className='mx-4'><FaYoutube size={30}/></li></a> 
</ul>
</div>
