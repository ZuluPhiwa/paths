  ...
  return (
    <div  style={{ backgroundColor: `${color}` }} className='fixed  left-0 top-0 w-full z-10 ease-in duration-300'>
        <div className='justify-between mx-2 md:mx-8 p-4 flex '>
            <h1 className=' font-bold text-teal-500'><Link to="/paths/">Paths</Link></h1>


            <ul style={{ color: `${textColor}` }} className='hidden md:flex'>
                <li className='mx-4'> <Link to="/paths/institutions">Institutions</Link>  </li>
                <li className='mx-4'> <Link to="/paths/careers">Careers</Link> </li>
                <li className='mx-4'> <Link to="/paths/contact">Contact Us</Link> </li>
            </ul>
        ...
        >
          <ul>
            ...
            <li onClick={handleNav} className='p-4 text-4xl hover:text-gray-500'>
            <Link to="/paths/institutions">Institutions</Link>
            </li>
            <li onClick={handleNav} className='p-4 text-4xl hover:text-gray-500'>
